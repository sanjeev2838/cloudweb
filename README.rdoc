...
------------------------------------------------
curl -X GET -H "Content-type: application/json"  http://localhost:3000/api/v1/hosts?'serialid=1234&&authcode=5e7add11cb09a9e70061776727555f4c'
---------------
...
inactive a machine :-
curl -X DELETE     http://localhost:3000/api/v1/hosts/1234

3.) parent profile :-
---------------------------------------------
 creating parent profile api :-

 curl -X POST -H "Content-type: application/json" -d '{"deviceid":231,"devicetypeid":0,"tokenid":"r32r32","serialid":"123","name":"rahul","imei":"123"}' http://localhost:3000/api/v1/profiles

 updating parent profile :-

 curl -X PUT -H "Content-type: application/json" -d '{"deviceid":231,"devicetypeid":0,"tokenid":"r32r32","serialid":"123","name":"rahul_update","imei":"123"}' http://localhost:3000/api/v1/profiles
...
5.) Creating log entries correspondint to child :-
 ...
 curl -X POST -H "Content-type: application/json" -d '{"log": "test"}' http://localhost:3000/api/v1/profiles
 curl -X POST -H "Content-type: application/json" -d '{"deviceid":23}' http://localhost:3000/api/v1/profiles
=======
----------------------------------------------------------------
...
>>>>>>> 1bdecdbbd3e1c423ea390edd973ebfb4afbc3930
