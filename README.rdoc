...
'{"01":"1441","08":"ipaddress","03":"test_version","02":"boot_varsion","04":"hw_config"}'
...
-------------------------
 ...
 3008 : parent profile already exist for that Email address
...
1.) curl -X GET -H "Content-type: application/json" http://localhost:3000/api/v2/suppliers/?brew_type=Gruel
2.) /api/v2/suppliers/<supplierid>/products
3.) /api/v2/suppliers/<supplier id>/products/<product id>/preferences
:( Registering new host ):
4.)curl -X POST -H "Content-type: application/json" -d '{"01":"1441","08":"ipaddress","03":"test_version","02":"boot_varsion","04":"hw_config"}'  http://localhost:3002/api/v2/hosts

echo  'data={"01":"0129ABCF"%2C "08":"192.168.0.50"%2C"03":"001"%2C"02":"001"%2C "04":"0"%2C"05":"no_error"%2C "06":"37"%2C "07":"3"}'|  curl -d @- http://localhost:3002/api/v2/hosts
echo  'data={"01":"0129AF"%2C "08":"192.168.0.50"%2C"03":"001"%2C"02":"001"%2C "04":"0"%2C"05":"no_error"%2C "06":"37"%2C "07":"3"}'|  curl -d @- http://d1.diluo.nu/api/v2/hosts

echo  'data={"64":"128","01":"12"}'|  curl -d @- http://d1.diluo.nu/api/v2/logs
echo  'data={"64":"128","01":"12"}'|  curl -d @- http://localhost:3002/api/v2/logs

echo  'data={"16":"test","serialid":"12"}'|  curl -d @- http://localhost:3002/api/v1/logs

# machine register with host_profile :-
=========================================
echo 'data={"01":"0123456789ABCDEF"%2C "08":"192.168.0.50"%2C"03":"001"%2C"02":"001"%2C "04":"0"%2C"05":"no_error"%2C "06":"37"%2C "07":"3"%2C"09":"09"%2C "10":"10"%2C "11":"11"%2C "12":"12"%2C "13":"13"%2C "14":"14"%2C "15":"15"%2C "16":"16"%2C "17":"17"%2C "18":"18"%2C "19":"19"%2C "20":"20"%2C "21":"21"%2C "22":"22"%2C "23":"23"%2C "24":"24"%2C "25":"25"%2C "26":"26"%2C "27":"27"%2C "28":"28"%2C "29":"29"%2C "30":"30"%2C "31":"31"}' | curl -d @- http://localhost:3002/api/v2/hosts

echo 'data={"01":"0123456789ABCDEF"%2C "08":"192.168.0.50"%2C"03":"001"%2C"02":"001"%2C "04":"0"%2C"05":"no_error"%2C "06":"37"%2C "07":"3"%2C"09":"09"%2C "10":"10"%2C "11":"11"%2C "12":"12"%2C "13":"13"%2C "14":"14"%2C "15":"15"%2C "16":"16"%2C "17":"17"%2C "18":"18"%2C "19":"19"%2C "20":"20"%2C "21":"21"%2C "22":"22"%2C "23":"23"%2C "24":"24"%2C "25":"25"%2C "26":"26"%2C "27":"27"%2C "28":"28"%2C "29":"29"%2C "30":"30"%2C "31":"31"}' | curl -d @- http://d1.diluo.nu/api/v2/hosts


# machine get profile :-
echo 'data={"01":"0123456789ABCDEF"}' |  curl -d @- http://localhost:3002/api/v2/gethostprofile
echo 'data={"01":"0123456789ABCDEF"}' |  curl -d @- http://d1.diluo.nu/api/v2/gethostprofile


Notes for future enhancements  :-
=====================================================
1.) I think there should be an many to many relationship between
parent and child profile not implemented yet because of miscommunication
but may required in future if client asks .
1.1) Model and table is already there we just need to create an entry in join table
in the controller .


2.) Child profile Pic use case  :-
2.1)  There is an Api for gettting all pictures of a specific child But i think
 there is no Screen in iphone and andriod  for selectng a pic as profile pic from a list of pics .
