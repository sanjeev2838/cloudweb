...
---------------------------------------------
 ...
 curl -X POST -H "Content-type: application/json" -d '{"deviceid":231,"devicetypeid":0,"tokenid":"r32r32","serialid":"123"}' http://localhost:3000/api/v1/profiles

 updating parent profile :-

 curl -X PUT -H "Content-type: application/json" -d '{"deviceid":4556,"devicetypeid":0,"imei":"32r2r223","tokenid":"123","serialid":"123"}' http://localhost:3000/api/v1/profiles/1
